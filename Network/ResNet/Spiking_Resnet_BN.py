...
class ResNet(nn.Module):
    def __init__(self, block, layers, imagenet=True, num_classes=1000, T=4, zero_init=False):
        super().__init__()
...
def ResNet18(num_classes=1000, imagenet=True, T=4, zero_init=False):
    model = ResNet(BasicBlock, [2, 2, 2, 2], imagenet=imagenet, num_classes=num_classes, T=T, zero_init=zero_init)
    return model


def ResNet34(num_classes=1000, imagenet=True, T=4, zero_init=False):
    model = ResNet(BasicBlock, [3, 4, 6, 3], imagenet=imagenet, num_classes=num_classes, T=T, zero_init=zero_init)
    return model


def ResNet50(num_classes=1000, imagenet=True, T=4, zero_init=False):
    model = ResNet(Bottleneck, [3, 4, 6, 3], imagenet=imagenet, num_classes=num_classes, T=T, zero_init=zero_init)
    return model


def ResNet101(num_classes=1000, imagenet=True, T=4, zero_init=False):
    model = ResNet(Bottleneck, [3, 4, 23, 3], imagenet=imagenet, num_classes=num_classes, T=T, zero_init=zero_init)
    return model


def ResNet152(num_classes=1000, imagenet=True, T=4, zero_init=False):
    model = ResNet(Bottleneck, [3, 8, 36, 3], imagenet=imagenet, num_classes=num_classes, T=T, zero_init=zero_init)
    return model